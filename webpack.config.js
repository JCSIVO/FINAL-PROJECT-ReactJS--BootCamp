...
// Para reducir el tamaño de las hojas d eestilo de nuestro proyecto
...
// Exportat configuracion de Webpack
module.exports = {
    ...
    module: {
        rules: [
            ...
            // Tienen que pasar el LINTING para poder pasar
            {
                ...
                use: [
                    'babel-loader', // Se cambia eslint-loader por babel-loader para que funcione
                    'source-map-loader',
                ],
            },
